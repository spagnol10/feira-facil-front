...
import feiraImg from "../../../public/image.png";
...
export default function AuthView() {
  ...
  return (
    <>
      <Header
        title="FeiraFácil - Login"
        content="Realize o seu login com facilidade."
      />
      <main className="w-full h-screen md:flex md:items-end">
        ...
        <div className="w-full h-full md:max-w-lg bg-white shadow-3xl">
            ...
            <div className="w-full p-6 h-3/4 md:h-min md:bg-white md:rounded-b-3xl md:p-10">
              <>
                ...
                <form onSubmit={(e) => e.preventDefault()} className="py-7">
                  <CustomInput
                    ...
                    value={formatPhoneInput(
                      viewModel.authFormFields.phone ?? ""
                    )}
                    invalid={
                      viewModel.authFormFields.phone
                        ? !validatePhone(viewModel.authFormFields.phone)
                        : false
                    }
                  ...
                  <span className="block pt-7">
                    <CustomInput
                      ...
                      onChange={viewModel.handleChange}
                      withEyeIcon
                      inputHeaderText="Senha"
                      value={viewModel.authFormFields.password}
                      type="password"
                    />
                  </span>
                  <span className="flex justify-end pt-4">
                    <button
                      onClick={() =>
                        viewModel.setAuthScreen(EnumAuthScreen.FORGOT_PASSWORD)
                      }
                ...
                <span>
                  <Button
                    text="Login"
                    disabled={!viewModel.enableLogin() || viewModel.loading}
                    onClick={viewModel.handleLogin}
                  />
                  <Button
                    text="Novo Usuário"
                    onClick={viewModel.handleStartCreateUser}
                ...
                {!viewModel.isForgotTokenSent ? (
                  <>
                    <p className="text-sm text-primary-gray mt-4">
                      Vamos enviar um código para seu WhatsApp, validando o
                      código já podemos relizar a troca da sua senha.
                    </p>
                    <p className="text-sm text-primary-gray mt-4">
                    ...
                    <div className="mt-8">
                      <Button
                        text="Enviar código"
                        onClick={() =>
                          viewModel.handleSendTokenNotification(true)
                        }
                        disabled={
                          !validatePhone(viewModel.authFormFields.phone)
                        }
                  ...
                  <div>
                    <form onSubmit={(e) => e.preventDefault()}>
                      <span className="block mt-6">
                        <CustomInput
                          ...
                          withEyeIcon
                          onChange={viewModel.handleChange}
                          placeHolder="Senha (Mais que 6 caracteres)"
                          inputHeaderText="Senha"
                          value={viewModel.authFormFields.password}
                          type="password"
                        />
                      ...
                      <span className="block mt-6">
                        <CustomInput
                          ...
                          withEyeIcon
                          onChange={viewModel.handleChange}
                          inputHeaderText="Digite a senha novamente"
                          value={viewModel.authFormFields.userConfirmPassword}
                          type="password"
                        />
                      </span>
                    </form>
                    <div className="mt-8">
                      <Button
                        ...
                        disabled={!viewModel.enableChangePassword()}
          ...
          {equalsEnum(
            ...
            EnumAuthScreen.SEND_VALIDATION_TOKEN
          ) && (
                ...
                <>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-sm text-primary-gray pt-4">
                      Para proteger sua conta, enviaremos um código de
                      verificação no seu WhatsApp.
                    </p>
                    <p className="text-sm text-primary-gray pt-4">
                    ...
                    <div className="mt-8">
                      <Button
                        text="Enviar código"
                        onClick={viewModel.handleSendTokenNotification}
                        disabled={
                          !validatePhone(viewModel.authFormFields.phone)
                        }
                      />
                  ...
                  <div className="mt-4">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                      <span className="block mt-6">
                        <CustomInput
                          ...
                          value={viewModel.authFormFields.userName}
                          type="text"
                        />
                      </span>
                    ...
                    <div className="mt-8">
                      <Button
                        text="Criar conta"
                        disabled={
                          !viewModel.enableCreateAccount() || viewModel.loading
                        }
