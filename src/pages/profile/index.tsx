    ...
    viewModel.isAuth && (
      <>
        ...
        <DefaultScreenLayout
          ...
          screen={EnumScreen.PROFILE}
        >
          <div className="flex flex-col md:h-full">
            <DefaultHeaderTitle
              title="Gerencie aqui suas informações👨‍🌾"
            ...
            <div>
              ...
              <div className="flex xl:w-4/5 flex-col gap-6 mt-10">
                <div className="flex flex-col gap-6 md:flex-row">
                  <span className="w-full">
                    <CustomInput
                      ...
                      onChange={(e) =>
                        utils.handleChange(e, viewModel.setUserData)
                      }
                    />
                  </span>
                  <span className="w-full">
                    <CustomInput
                      ...
                      invalid={
                        viewModel.userData.email
                          ? !utils.validateEmail(viewModel.userData.email)
                          : false
                      }
                  ...
                  <span className="w-full flex flex-col md:flex-row gap-6">
                    <span className="w-full gap-6 flex">
                      <span className="w-full">
                        <CustomInput
                          id="document"
                          disabled={!viewModel.isCompleteRegister}
                          maxLength={14}
                          value={utils.formatCPFInput(
                            viewModel.userData?.document ?? ""
                          )}
                          placeHolder="Insira seu CPF"
                          invalid={
                            viewModel.userData.document
                              ? !utils.validateCPF(viewModel.userData.document)
                              : false
                          }
                      ...
                      <span className="w-full">
                        <CustomInput
                          id="phone"
                          type="tel"
                          value={utils.formatPhoneInput(
                            viewModel.userData?.phone ?? ""
                          )}
                          maxLength={15}
                          invalid={
                            viewModel.userData.phone
                              ? !utils.validatePhone(viewModel.userData.phone)
                              : false
                          }
                          disabled={true}
                    ...
                    <span className="w-full gap-6 flex">
                      <span className="w-full">
                        <DefaultSelectOne
                          handleSelect={(e: any) =>
                            viewModel.handleUpdateGender(e)
                          }
                          inputHeaderText="Sexo"
                          options={["Masculino", "Feminino"]}
                          optionValue={
                            viewModel.userData?.gender
                              ? viewModel.parseGenderStrToEnum()
                              : "Selecione"
                          }
                        />
                      </span>
                      <span className="w-full">
                        <CustomInput
                          ...
                          disabled={!viewModel.isCompleteRegister}
                          maxLength={10}
                          value={utils.formatDateDDMMYYYYInput(
                            viewModel.userData?.birthdate ?? ""
                          )}
                          placeHolder="Insira Data Nascimento"
                          invalid={
                            viewModel.userData.birthdate
                              ? !utils.isValidateBirtday(
                                  viewModel.userData.birthdate
                                )
                              : false
                          }
                ...
                >
                  <span className="w-full">
                    <CustomInput
                      ...
                      type="password"
                      withEyeIcon
                      value={viewModel.userData?.password ?? ""}
                  ...
                  <span className="w-full">
                    <CustomInput
                      id="passsword-confirm"
                      disabled={!viewModel.isPasswordChanged()}
                      type="password"
                      withEyeIcon
                      ...
                      inputHeaderText="Confirme a senha"
                      onChange={(e) =>
                        viewModel.setConfirmPassword(e.target.value)
                      }
                    />
                  </span>
                </form>
                <p className="text-sm ">
                  ...
                  <span className="font-semibold">Confirmar a senha</span> é
                  utilizado somente em casos de alteração da senha.
                </p>
              </div>
